var e = function (e, t) {
    ...
    o = {
        state: 0,
        ios: uni.getSystemInfoSync().system.toUpperCase().indexOf('IOS') >= 0
    },
    u = function (e, t, n) {
        var r = function (e, t) {
            return e === t;
        ...
        for (var c in e)
            if (r(e[c].uuid.toLowerCase(), t.toLowerCase()) && (!n.read || e[c].properties.read) && (!n.write || e[c].properties.write) && (!n.notify || e[c].properties.notify))
                return !0;
    ...
    f = function e(t, n) {
        ...
        switch ((console.log(t, n, o.state), t)) {
            case c.VpSPQ:
                if (c.vAxIH(o.state, 0)) o.state = 1;
                else if (c.zNFqt(o.state, 7)) return c.LVmHl;
                (o.info = n.info), (o.frimdata = n.frimdata);
                break;

            case c.tHAps:
                if (c.SegTB(o.state, 1))
                    return void (
                        n.fail &&
                        n.fail({
                            errMsg: c.dRQpU
                ...
                o.timeout && (c.pyJcV(clearTimeout, o.timeout), (o.timeout = void 0)),
                    c.oqYFs(o.retry, !0) && ((o.connectTime = new Date().getTime()), (o.connectArgs = n), (o.deviceId = n.deviceId)),
                    c.UplDU(
                        setTimeout,
                        function () {
                            uni.onBLEConnectionStateChange(l),
                                (o.state = 2),
                                console.log(c.jwcJz),
            ...
            case c.HTwGN:
                ...
                if (((o.state = 4), !uni.setBLEMTU)) return c.XucsG(e, c.qttlt, 23);
                uni.setBLEMTU({
                    deviceId: o.deviceId,
                    mtu: 69,
                    success: function (t) {
            ...
            case c.oqbDY:
                for (var w = c.CHRDA.split('|'), h = 0; ; ) {
                    switch (w[h++]) {
                        case '0':
                            uni.onBLECharacteristicValueChange(p);
                            continue;
                        ...
                        case '3':
                            if (
                                !(
                                    c.klJQl(u, n.characteristics, o.ctl_uuid, {
                                        write: !0
                                    }) &&
            ...
            case c.TwYam:
                for (var M = c.CMHQj.split('|'), k = 0; ; ) {
                    switch (M[k++]) {
                        ...
                        case '1':
                            uni.offBLECharacteristicValueChange(p);
                            continue;
            ...
            case c.kpIYf:
                ...
                if (c.AlmZd(o.state, 7)) {
                ...
                } else if (c.AlmZd(o.state, 9))
                    for (var V = c.CXjNJ.split('|'), C = 0; ; ) {
                        switch (V[C++]) {
                            case '0':
                                o.state = 10;
                                continue;
                    ...
                    if (c.AlmZd(o.state, 8) || c.AlmZd(o.state, 10)) {
                        ...
                        if (c.OGnCB(o.state, 10))
                            for (var x = c.Iiimt.split('|'), L = 0; ; ) {
                                switch (x[L++]) {
                                    case '0':
                                        I = c.behPg(r, n, 2);
                                        continue;
                    ...
                    if (c.OGnCB(o.state, 11))
                        for (var y = c.jEVdU.split('|'), B = 0; ; ) {
                            switch (y[B++]) {
                                case '0':
                                    o.state = 12;
                                    continue;
                        ...
                        if (c.gqZoC(o.state, 13))
                            return n
                                ? ((o.state = 14),
                                  void uni.closeBLEConnection({
                                      deviceId: o.deviceId
                                  }))
                                : ((o.state = 12),
                                  void (
                                      o.rebootModeArgs.fail &&
                                      o.rebootModeArgs.fail({
                                          errMsg: c.QpDkx
                                      })
                                  ));
                        if (c.gqZoC(o.state, 15)) (o.state = 16), c.CuGeb(a, c.RIqkf, 5e3);
                        else if (c.pOWsg(o.state, 16))
                            for (var O = c.FaRQS.split('|'), q = 0; ; ) {
                                switch (O[q++]) {
                                    case '0':
                                        o.txPackets = 0;
                                        continue;
                        ...
                        else if (c.pOWsg(o.state, 17))
                            for (var Q = c.tpUzy.split('|'), _ = 0; ; ) {
                                switch (Q[_++]) {
                                    case '0':
                            ...
                            if (((o.state = 19), !c.CuGeb(a, c.DTEmf, 5e3)))
                                return (
                                    (o.state = 20),
                                    c.CuGeb(e, c.lxsaS, {
                                        write: !0
                        ...
                        } else if (c.SKOol(o.state, 19))
                            for (var P = c.raIpX.split('|'), F = 0; ; ) {
                                switch (P[F++]) {
                                    case '0':
            ...
            case c.ggfkc:
                var R = new Uint8Array(n.value),
                    H = c.PFEVO(R[0], c.odUpR(R[1], 8));
                if (c.SKOol(H, c.YYOfb(o.opcode, 1))) return o.timeout && (c.vgZcx(clearTimeout, o.timeout), (o.timeout = void 0)), c.SzdDW(e, c.kpIYf, R);
                if (c.kKLjB(H, 55559))
                    return c.tPGpo(e, c.cVBFe, {
                        report: R
                    });
                break;

            case c.JULOw:
                if ((o.timeout && (c.vgZcx(clearTimeout, o.timeout), (o.timeout = void 0)), c.kKLjB(n.errCode, 10008)))
                    return void c.hFzjW(
                        setTimeout,
                        function () {
            ...
            case c.XHLNe:
                ...
                if (c.eYSDN(o.txPackets, 10) && ((o.txPackets = 0), o.ios))
                    return c.FRyFw(
                        setTimeout,
                        function () {
                ...
                (n = {
                    ...
                    (o.txSize += c.MUaSL(o.mtu, 3)),
                    (o.txSize = c.JhpKE(o.txSize, o.frimSize) ? o.frimSize : o.txSize),
                    o.txPackets++;
            ...
            case c.cVBFe:
                ...
                if (n.report) {
                    ...
                    if ((c.qawhw(z, 6) ? (T = c.YGqEB) : c.qawhw(z, 9) ? (T = c.KpPgS) : c.nSDRH(z, 8) && (T = c.rCLYs(c.VXVso, z)), T))
                        return void (
                            o.updateArgs.fail &&
                            ((o.updating = !1),
                            (o.state = 12),
            ...
            case c.iYjNb:
                for (var j = c.GwAcJ.split('|'), N = 0; ; ) {
                    switch (j[N++]) {
                        ...
                        case '2':
                            if (c.YQbQF(o.info.frimVer, o.frimVer))
                                return void (
                                    n.fail &&
                                    n.fail({
                                        errMsg: c.zTECt
            ...
            case c.lYIab:
                ...
                if (c.LLiWN(o.state, 14) && (console.log(o), c.ImXZB(o.rebootModeArgs.reconnect, !1)))
                    for (var U = c.VxFtb.split('|'), J = 0; ; ) {
                        switch (U[J++]) {
                            case '0':
                ...
                c.YSIYD(o.state, 12) &&
                    (c.LLiWN(o.state, 14)
                        ? ((o.workMode = o.rebootModeArgs.mode || 0),
                          o.connectArgs.connected &&
                              o.connectArgs.connected({
                                  appVer: o.appVer,
                                  stackVer: o.stackVer,
    ...
    load: function (e) {
        for (
            ...
            switch (o[u++]) {
                ...
                case '1':
                    for (var a = 0; i.wbBHO(a, p); a += 32)
                        for (var s = i.XfMkm.split('|'), d = 0; ; ) {
                            switch (s[d++]) {
                                case '0':
                ...
                case '12':
                    if (
                        i.QcGVf(i.qtAKf(r, e, i.TfyIG(b, 6)), 35293) ||
                        i.QcGVf(i.zjiBB(n, e, 0, i.TfyIG(b, 2), 0), i.qtAKf(r, e, i.JIbIO(b, 2))) ||
                        i.hNisL(i.zjiBB(t, e, 0, i.fYmpZ(b, 4), 0), i.qtAKf(r, e, i.fYmpZ(b, 4)))
                    )
                        return i.EDybP;
                    continue;
    ...
    otaBeaconStart: function (e) {
        for (
            ...
            switch (n[r++]) {
                ...
                case '2':
                    o.beaconServer
                        ? (o.beaconServer.stopAdvertising(), t.mdzfo(g))
                        : uni.createBLEPeripheralServer({
                              success: function (e) {
