var e = require('@babel/runtime/helpers/typeof.js'),
    t = require('./4F97F14255C842DF29F19945DB418C74.js'),
    r = {
        tag_type: null
    },
    n = [[]],
...
function o(t, r) {
    return function (n) {
        if (t instanceof Uint8Array || t instanceof Array) -1 != t.indexOf(n.status) ? r(n) : a(n.status);
        else {
...
module.exports = {
    ...
    getMifareKeysMap: function () {
        for (var e = {}, r = 0, n = 0; r < s.length; r += 2, n++) {
            var u = null != s[r] ? t.bytes2hex(s[r]) : null,
                a = null != s[r + 1] ? t.bytes2hex(s[r + 1]) : null;
            e[n] = {
                keya: u,
                keyb: a
            };
