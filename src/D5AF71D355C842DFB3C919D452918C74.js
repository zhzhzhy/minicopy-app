var e = require('@babel/runtime/helpers/createForOfIteratorHelper.js'),
    t = require('@babel/runtime/helpers/typeof.js'),
    n = require('./4F97F14255C842DF29F19945DB418C74.js'),
    r = require('./8473358655C842DFE2155D813E918C74.js'),
    o = [
        'ffffffffffff',
        '000000000000',
        'a0a1a2a3a4a5',
...
function k(e) {
    ...
    var n = r.getTagInformation().uid_hex,
        o = 'keys_'.concat(n).toLowerCase();
    uni.setStorageSync(o, t);
}
    ...
    try {
        ...
        switch (t.code) {
            ...
            case 8:
                ...
                var c;
                1 == t.code && (c = '开发者调用AI制卡接口时传输的参数有误！'),
                    7 == t.code && (c = 'AI制卡计算机离线，请联系管理员处理此异常情况！'),
                    8 == t.code && (c = 'MP服务器出现错误，请联系管理员处理此异常情况！'),
                    (function (e) {
                        uni.showModal({
                            title: '无法自动解决的硬性错误！',
                            showCancel: !1,
...
function b() {
    ...
    e > 0
        ? null != a
            ? (console.log('WS自动释放定时器检测到当前存在 '.concat(e, ' 个解密任务，短时间内将不会关闭链接！')),
              null == l &&
                  (console.log('开始ping服务器， 在'.concat(2e3, ' 毫秒后不pong就认为服务器死了。')),
                  a.send({
                      data: 'ping'
                  }),
...
function v(e) {
    if (null == a) {
        var t = n.getDeviceFactroyOTPInfo(),
            o = ''.concat('wss://rcopy.nikola-lab.cn/server1/websocket/decrypt', '?serial=').concat(t.serial);
        (a = uni.connectSocket({
            url: o,
            timeout: 2e3,
            success: function (e) {
        ...
        v(function () {
            ...
            null != a
                ? ((s[o] = r),
                  ...
                  (c = setInterval(b, 5e3)))
                : console.log('与解密服务器的WS链接不存在，无法发起解密任务！');
        });
}
        ...
        h = function (h) {
            if (h.length > 0) {
                ...
                u <= 30
                    ? y >= 3
                        ? ((y = 0),
                          r.requestNestedDistDetect(e, t, o, 3e3, function (e) {
                              (l = n.bytes2NestedDistObj(e.data)), console.log('检测到之前的Distance无法解密出密钥，重新采集Distance，解析结果是: ' + JSON.stringify(l)), k();
                          }))
                        : ((y += 1), k())
                    : s(null);
        },
...
function x(e) {
    for (var t = Object.keys(e), r = 0; r < t.length; r++) {
        var o = t[r],
            a = n.mifare_to_trail_block(n.mifare_sector_2_block(o));
        if (null != e[o].keya)
            return {
                block: a,
                type: 96,
...
function K(e, t) {
    for (var n = Object.keys(t), r = 0; r < n.length; r++) {
        ...
        void 0 === e[o] &&
            ...
            null != t[o].keya && (e[o].keya = t[o].keya),
            null != t[o].keyb && (e[o].keyb = t[o].keyb);
    }
}
...
function M(t, o, a) {
    ...
    var s = function (t) {
            ...
            try {
                for (s.s(); !(r = s.n()).done; ) {
                    var i = r.value;
                    1 == ((t.data[(i / 8) & 255] >> (i % 8 & 255)) & 1) && ((l[i].keyb = n.bytes2hex(t.data, 6 * o + 5, 6)), o++);
                }
            } catch (e) {
                s.e(e);
            } finally {
    ...
    r.requestFCheckMfNSecKeys(t, o, i, function (e) {
        for (var c = 0, i = 0; i < t.length; i++) {
            var u = e.data.slice(c, c + 2),
                f = 255 != u[0],
                y = 255 != u[1],
                k = f ? n.bytes2hex(o[u[0]], 0, 6) : null,
                d = y ? n.bytes2hex(o[u[1]], 0, 6) : null;
            (l[i] = {
                keya: k,
                keyb: d
            }),
        ...
        if (m(l)) console.log('本次密钥检索已经发现全部的密钥！'), a(l);
        else if (N(l) > 0) {
            if (
                (function (e) {
                ...
                console.log('本次密钥检索已经发现全部的密钥B！'), a(l);
            else {
                var h = {},
                    g = Object.keys(l);
                ...
                var b = Object.keys(h);
                b.length > 0
                    ? (console.log('本次密钥检索有未发现的密钥B，将启动读取，需要读取的密钥B的个数是: ' + b.length), r.requestMfReadKeyBByKeyA(h, 3e3, s))
                    : (console.log('本次密钥检索没有未发现的密钥B。'), a(l));
            }
...
function R(e, t, n, o) {
    var a = T(e),
        ...
        l = {},
        s = J();
    console.log('开始尝试扫描空标签，第一步是fchk。'),
        y('fchk', c, s.length, I(a)),
        M(a, s, function (e) {
...
module.exports = {
    ...
    requestNestedKeyForSize: function (e, t) {
        ...
        function i(e) {
            var t,
                o = x(c),
                a = n.hex2bytes(o.key_hex);
            (t = A(c) ? q(c) : j(c)),
                console.log('需要解密的目标扇区数据: ' + JSON.stringify(t)),
                null != l
                    ? (console.log('Distance已经采集过，采集历史是: ' + JSON.stringify(l)), F(a, o, t, l, e))
                    : (console.log('开始侦测距离: '.concat(JSON.stringify(o), ', ').concat(o.key_hex)),
                      r.requestNestedDistDetect(o.block, o.type, a, 3e3, function (r) {
                          (l = n.bytes2NestedDistObj(r.data)), console.log('第一次获取Distance，解析结果是: ' + JSON.stringify(l)), F(a, o, t, l, e);
                      }));
        }
        ...
        var u = function (e) {
            ...
            f = function (e) {
                ...
                var t = n.mifare_block_2_sector(e.block),
                    l = {};
                l[t] = {
                    keya: null,
                    keyb: null
                ...
                96 == e.type ? (l[t].keya = s) : (l[t].keyb = s), K(c, l), y('nested', a, D(c), c), M(o, [s], u);
            },
            k = function (e) {
        ...
        console.log('开始尝试解密普通标签，第一步是fchk。'),
            y('fchk', a, s.length, I(o)),
            M(o, s, function (e) {
                K(c, e), m(e) ? t(c) : C(e) ? (y('darkside', a, 0, c), p(3, 96, 21, d)) : (y('nested', a, D(c), c), i(f));
            });
    },
    requestFastSTKeyForSize: function (e, t) {
        ...
        function s(e) {
            var t,
                r = x(c),
                o = n.hex2bytes(r.key_hex);
            (t = A(c) ? q(c) : j(c)), O(r.block, r.type, o, t.block, t.type, e);
        }

        var i = function (e) {
                K(c, e), m(c) ? (y('staticnested', a, D(c), c), t(c)) : (y('staticnested', a, D(c), c), s(u));
            },
            u = function (e) {
                if (null == e) return r.throwTagErrorEvent(38), void console.log('解密失败了，nested超过重试上限还是未能解密该卡片！');
                var t = n.mifare_block_2_sector(e.block),
                ...
                var s = n.bytes2hex(e.key, 0, e.key.length);
                96 == e.type ? (l[t].keya = s) : (l[t].keyb = s), K(c, l), y('staticnested', a, D(c), c), M(o, [s], i);
            },
            f = function (e) {
                44 == e.status ? s(u) : r.throwTagErrorEvent(41);
            };

        console.log('开始尝试解密ST标签，第一步是fchk。'),
            y('fchk', a, l.length, I(o)),
            M(o, l, function (e) {
                if ((K(c, e), m(e))) t(c);
                else if (C(e)) y('darkside', a, 0, c), r.throwTagErrorEvent(41);
                else {
                    y('staticnested', a, D(c), c);
                    var o = x(c),
                        l = n.hex2bytes(o.key_hex);
