var e = require("4F97F14255C842DF29F19945DB418C74.js"), t = require("8473358655C842DFE2155D813E918C74.js"), n = require("D5AF71D355C842DFB3C919D452918C74.js"), a = !1, o = !1, r = null, l = [];
...
function c(n, a) {
    var o = n.data[10], r = {
        ...
        0 == e.status ? (r.tag_type = t.TAG_TYPE_MF1_MAYBE, r.readable = !0) : r.tag_type = t.TAG_TYPE_HF_14443A, 
        a(r);
    };
    e.request14AGetATSDataArr(1500, function(t) {
        0 == t.status && null != t.data && t.data.length > 0 && (r.ats_hex = e.bytes2hex(t.data, 0, t.data.length)), 
        e.requestCheckMf3TimeAuth(1500, l);
    });
}
...
function s(n) {
    var a = {}, o = function(e) {
        if (0 == e.status) a.tag_type = t.TAG_TYPE_MF1_STDWK, n(a); else if (36 == e.status) a.tag_type = t.TAG_TYPE_MF1_STDST, 
        n(a); else {
            if (37 != e.status) {
        ...
        1 != e.status ? 0 != e.status ? t.requestNestedNTLoophole(1500, o) : (a.tag_type = t.TAG_TYPE_MF1_GEN1A, 
        a.readable = !0, n(a)) : t.throwTagErrorEvent(1);
    };
...
function g(n, a, o, r, l) {
    var c = e.mifare_sector_2_block(n), u = {};
...
function T(t, n, a, o) {
    ...
    g(t, 96, n, r, function(n) {
        var l, c;
        l = n, c = !0, Object.keys(l).forEach(function(e) {
            null == l[e] && (c = !1);
        }), c ? o(n) : (r = function(t, n) {
            var a = [];
        ...
        }(n, t), console.log("扇区".concat(t, "读取失败的block: ") + JSON.stringify(r)), g(t, 97, a, r, function(e) {
            var t, a, r;
            o((t = n, a = e, r = {}, Object.keys(t).forEach(function(e) {
...
function h(a, o) {
    var r = t.getMifareTagDatas(), l = t.getMifareCardKeys();
    r.length = 0, l.length = 0, a(t.getTagInformation().max_block, function(a) {
        n.setCacheKesy4Mifare(a);
        for (var c = Object.keys(a).length, u = 0; u < c; u++) {
            var s = e.hex2bytes(a[u].keya), i = e.hex2bytes(a[u].keyb);
            l.push(s), l.push(i);
        }
        console.log(" "), console.log("密钥获取完成，开始以获得的密钥读取所有的扇区："), function n(l) {
            if (l >= c) o(100); else {
                var u = e.hex2bytes(a[l].keya), s = e.hex2bytes(a[l].keyb);
                T(l, u, s, function(a) {
                    var i = Object.keys(a);
                    console.log("----------------------------------------------------------------------------------------"), 
                    i.forEach(function(n, o) {
                        ...
                        if (o == i.length - 1) {
                            var f = new Array();
                            Array.prototype.push.apply(f, u), null == a[n] ? Array.prototype.push.apply(f, [ 0, 0, 0, 0 ]) : Array.prototype.push.apply(f, a[n].slice(6, 10)), 
                            Array.prototype.push.apply(f, s), c = f, console.log("拼接密钥: ".concat(e.bytes2hex(u), " -- ").concat(e.bytes2hex(s), "，块").concat(e.mifare_sector_2_block(l) + o));
...
function S(e) {
    var n = function(n) {
        n.tag_type == t.TAG_TYPE_MF1_GEN1A ? b(n) ? function(e) {
            I(x(), !0, e);
        }(e) : t.throwTagErrorEvent(99) : n.tag_type == t.TAG_TYPE_MF1_STDWK || n.tag_type == t.TAG_TYPE_MF1_STDST || n.tag_type == t.TAG_TYPE_MF1_STDHD ? b(n) ? function(e) {
            var n = x();
            !function(e) {
                for (var n, a, o = t.getMifareCardKeys(), r = new Array(), l = 0; l < o.length; l++) r.push([ 255, 255, 255, 255, 255, 255 ]);
                var c = function(l) {
                    if (m(l.data, r.length)) console.log("此容器卡是原卡的密钥！"), e(o); else {
                        console.log("此容器卡有非原卡的密钥，将尝试合并原卡和空卡密钥！"), n = l.data;
                        for (var c = [], u = 0; u < r.length; u++) {
                            var s = 1 == (a[parseInt(u / 8)] >> parseInt(u % 8) & 1), i = 1 == (n[parseInt(u / 8)] >> parseInt(u % 8) & 1);
                            s ? c.push(r[u]) : i && c.push(o[u]);
                        }
                        c.length == r.length ? (console.log("合并成功，已经发现该容器卡所有的可用密钥！"), e(c)) : (console.log("合并失败，未发现该容器卡所有的可用密钥！"), 
                        t.throwTagErrorEvent(42));
                    }
                };
                console.log("开始检索默认密钥，密钥数量是: " + r.length), t.requestAuthMF1KnownKeys(r, 5e3, function(n) {
                    m(n.data, r.length) ? (console.log("此容器卡全都是默认密钥！"), e(r)) : (a = n.data, console.log("此容器卡有非默认密钥，将进行原卡密钥检索！"), 
                    t.requestAuthMF1KnownKeys(o, 5e3, c));
                });
            }(function(t) {
                G(t, n, !0, e);
            });
        }(e) : t.throwTagErrorEvent(99) : t.throwTagErrorEvent(98);
    }, a = function(e) {
        e.tag_type == t.TAG_TYPE_MF1_MAYBE ? s(function(t) {
...
function x() {
    var n = e.getStorageSyncHasDefault("auto_invalid_acs_fix", !0), a = e.getStorageSyncHasDefault("use_anticollision_sak", !0);
    console.log("是否启用了自动修复控制位: " + n), console.log("是否启用了自动修复SAK: " + a);
    var o = new Array();
    return t.getMifareTagDatas().forEach(function(r, l) {
        var c = r;
        0 == l ? null == c ? (c = M(), console.log("厂商块为空，自动修正后的数据是: " + e.bytes2hex(c))) : a && 8 == t.getTagInformation().uid_hex.length ? (c = M(c), 
        console.log("厂商块不为空，强行修正SAK后的数据是: " + e.bytes2hex(c))) : console.log("厂商块不为空且无需修正厂商块。") : e.mifare_is_trailer_blk(l) ? null == c ? n ? (c = e.hex2bytes(t.TAG_MF1_DEFAULT_TRAI), 
        console.log("尾部块".concat(l, "为空，自动修正为默认尾部块"))) : (c = e.hex2bytes(t.TAG_MF1_DEFAULT_DATA), 
        console.log("尾部块".concat(l, "为空，不自动修正为默认尾部块，而是使用空的数据填充，此操作可能会导致卡片锁死。"))) : 0 == c[6] && 0 == c[7] && 0 == c[8] && 0 == c[9] && (n ? (c[6] = 255, 
        c[7] = 7, c[8] = 128, c[9] = 105, console.log("尾部块".concat(l, "控制位为空，自动修正为默认控制位，此操作可避免锁卡。"))) : console.log("尾部块".concat(l, "控制位为空，但是不自动修正，此操作可能会导致卡片锁死。"))) : null == c && (c = e.hex2bytes(t.TAG_MF1_DEFAULT_DATA), 
        console.log("数据块".concat(l, "为空，自动修正为空的数据块。")));
        o.push(c);
    }), o;
}
...
function G(n, a, o, r) {
    var c = a.length, u = e.mifare_secs_count_all(c);
    o || (l.length = 0);
    for (var s = 0; s < n.length; s += 2) console.log("索引是: ".concat(s, ", 密钥是A: ").concat(e.bytes2hex(n[s]), "，密钥B是: ").concat(e.bytes2hex(n[s + 1])));
    var i = function(e) {
        d([ 0, 3 ], e) ? (console.log("写卡全部成功（包括厂商块）"), r(100)) : d([ 3 ], e) ? (console.log("写卡部分成功（只有尾部块）"), 
        o ? t.throwTagErrorEvent(46) : (l.push(0), r(100))) : (console.log("写卡不成功（厂商块和尾部块都失败！）"), 
        o ? t.throwTagErrorEvent(45) : (l.push(0, 3), r(100)));
    };
    console.log("扇区数量总数: " + u), function c(s) {
        if (s >= u) {
            var f = [ a[0], a[3] ];
            return g = n[0], T = n[1], D = i, void p(0, 96, g, F = [ 0, 3 ], h = f, function(e) {
                if (d([ 0, 3 ], e)) D(e); else {
                    F = [];
                    var t = [];
                    0 == e[0] && (F.push(0), t.push(h[0])), 0 == e[3] && (F.push(3), t.push(h[1])), 
        ...
        var g, T, h, D, F, b = e.mifare_sector_2_block(s), S = b + e.mifare_blks_count_sec(s), M = a.slice(b, S), x = n[parseInt(2 * s)], m = n[parseInt(2 * s + 1)];
        !function(e, t, n, a, o) {
            var r = _(e);
...
function I(n, a, o) {
    var r = 16, l = n.length, c = function(t) {
        a ? e.requestUnlockChineseTag(3e3, function(t) {
            0 == t.status ? e.requestUplockChineseTag(3e3, function(e) {
                o(100), console.log("GEN1A上锁".concat(0 == e.status ? "成功" : "失败"));
            }) : o(100);
        }) : o(100);
    };
    console.log("上限块是: " + l), function e(a) {
        if (a >= l) t.requestWRBLOnceGen1ATag(0, n[0], 2e3, c); else {
            console.log("当前的写开始位置: " + a + ", 上限block：" + l);
            var u = n.slice(a, a + r);
            t.requestWRBLMoreGen1ATag(a, u, 3e3, function(n) {
                a += r;
                for (var c = 0; c < r; c++) if (!f(n.data, c)) return console.log("后门block写入失败: " + (c + a)), 
                void t.throwTagErrorEvent(43);
...
Y[t.TAG_TYPE_HF_14443A] = null, Y[t.TAG_TYPE_LF_EM410X] = function(e) {
    e(100);
    ...
    var a = t.getMifareTagDatas(), o = t.getMifareCardKeys();
    ...
    console.log("上限块是: " + l), function c(u) {
        u >= l || (console.log("当前的读开始位置: " + u + ", 上限block：" + l), t.requestRDBLMoreGen1ATag(u, r, 3e3, function(s) {
            for (var i = e.chunkArray(s.data.slice(2), 16), _ = 0; _ < i.length; _++) {
                ...
                if (a[T] = g, e.mifare_is_trailer_blk(T)) {
                    var h = g.slice(0, 6), p = g.slice(10, 16), y = e.mifare_block_2_sector(T);
                    o[2 * y] = h, o[2 * y + 1] = p;
                }
            }
...
P[t.TAG_TYPE_HF_14443A] = null, P[t.TAG_TYPE_LF_EM410X] = function(n) {
...
}, P[t.TAG_TYPE_MF1_GEN1A] = S, P[t.TAG_TYPE_MF1_STDWK] = S, P[t.TAG_TYPE_MF1_STDST] = S, 
...
w[t.TAG_TYPE_HF_14443A] = null, w[t.TAG_TYPE_LF_EM410X] = null, w[t.TAG_TYPE_MF1_GEN1A] = function(e) {
    I(X(t.getTagInformation()), !1, e);
}, w[t.TAG_TYPE_MF1_STDWK] = k, w[t.TAG_TYPE_MF1_STDST] = k, w[t.TAG_TYPE_MF1_STDHD] = k;
...
function C(e) {
    for (var t = B(), n = "dump_file_uuid_".concat(e), a = !0, o = !1, r = 0; r < t.length; r++) if (t[r] == e) {
        t.splice(r, 1), o = !0;
        break;
    }
    if (o) try {
...
function N(n) {
    ...
    return a.length = 0, n.tag_data.forEach(function(t, n) {
        if (e.mifare_is_trailer_blk(n)) {
            var o = t.slice(0, 6), r = t.slice(10, 16);
            a.push(o), a.push(r), console.log("加载块".concat(n, "的Key: ").concat(e.bytes2hex(o), " -- ").concat(e.bytes2hex(r)));
        }
    }), !0;
}

L[t.TAG_TYPE_HF_14443A] = null, L[t.TAG_TYPE_LF_EM410X] = function() {
    return [];
}, L[t.TAG_TYPE_MF1_MAYBE] = O, L[t.TAG_TYPE_MF1_GEN1A] = O, L[t.TAG_TYPE_MF1_STDWK] = O, 
L[t.TAG_TYPE_MF1_STDST] = O, L[t.TAG_TYPE_MF1_STDHD] = O;
...
function X(n) {
    for (var a = [], o = n.max_block + 1, r = 0; r < o; r++) 0 == r ? a.push(M(null, n)) : e.mifare_is_trailer_blk(r) ? a.push(e.hex2bytes(t.TAG_MF1_DEFAULT_TRAI)) : a.push(e.hex2bytes(t.TAG_MF1_DEFAULT_DATA));
    return a;
}

W[t.TAG_TYPE_HF_14443A] = null, W[t.TAG_TYPE_LF_EM410X] = function(e) {
    return !0;
}, W[t.TAG_TYPE_MF1_MAYBE] = N, W[t.TAG_TYPE_MF1_GEN1A] = N, W[t.TAG_TYPE_MF1_STDWK] = N, 
W[t.TAG_TYPE_MF1_STDST] = N, W[t.TAG_TYPE_MF1_STDHD] = N, module.exports = {
    getStorageSyncHasDefault: e.getStorageSyncHasDefault,
    startLoopTagScanner: function(n, r, l, s) {
        a = !0, o = !1;
        var i = !0, f = new Date().getTime();
        e.requestOnce14AFieldScan(3e3, function _(g) {
            if (0 == a || 0 == e.isBLEDeviceIsConnected()) return console.log("强行结束自动搜索标签的过程！"), 
            void (o = !0);
            var T = 0;
    ...
    startHFTagOneSearch: function(n, a) {
        e.requestOnce14AFieldScan(3e3, function(e) {
            if (0 != e.status) t.setTagInformation(null), a(); else {
                c(e, function(e) {
    ...
    startLFTagOneSearch: function(n, a) {
        e.requestOnce410FieldScan(2e3, function(e) {
            if (64 != e.status) t.setTagInformation(null), a(); else {
                u(e, function(e) {
                    t.setTagInformation(e), n(e);
                });
            }
    ...
    deleteDumpFilesByID: function(e) {
        ...
        if (Array.isArray(e)) {
            for (var t = !0, n = 0; n < e.length; n++) 0 == C(e[n]) && (console.log("有一个删除DUMP信息的任务失败了，其UUID是: " + e[n]), 
            t = !1);
            return t;
        }
    ...
    loadFile2DataBuffer: function(e) {
        ...
        var a = W[t.getTagInformation().tag_type], o = !0;
        return null != a ? o = a(n) : console.log("标签类型 ".concat(t.getTagInformation().tag_type, " 不支持加载数据到内存中，自动跳过！")), 
        o;
    }
};