...
function N(e) {
    if (e.deviceId == v && 0 == e.connected) {
        ...
        o.length = 0, wx.offBLEConnectionStateChange(N), E && wx.getBluetoothAdapterState({
            success: function(e) {
                console.log("重启搜索成功: " + JSON.stringify(e)), e.available ? $() : console.warn("警告，ble-device.js判断到在设备断开后，蓝牙适配器也不可用，将跳过自动启动扫描！");
            },
            fail: function(e) {
...
function H() {
    ...
    try {
        ...
        var n = null;
        if (b > 0 && (n = a.slice(A, A + b), A += b), 23 != a[A++] || 4 != a[A++]) return console.error("包尾无效"), 
        void (e = !0);
        ...
        e && function() {
            ...
            z(), y.count > 15 ? (console.error("BLE通信异常，但是重试次数也超过上限，无法继续重试！"), e(), S()) : "function" == typeof y.call && null != y.data ? (e(), 
            y.count += 1, console.log("BLE通信重试次数: " + y.count), oe(y.data, y.call)) : (console.error("BLE主动回复了奇怪的不符合包格式数据，将不会自动重试，并且需要通知上层！"), 
            S());
        }();
    }
}
...
function Z(e) {
    if (e.value.byteLength <= 0) console.log("无效的数据接收长度，跳过本次操作！"); else {
...
function $() {
    Y(), s || l ? console.log("开发者重复调用了扫描，这是不应该的！") : (l = !0, wx.startBluetoothDevicesDiscovery({
            ...
            0 == n.errno ? (s = !0, function() {
                ...
                r.forEach(function(e) {
                    ...
                    for (var e = 0; e < r.length; e++) {
                        ...
                        o >= t.lastFoundTimeStamp ? o - t.lastFoundTimeStamp > 2500 && (console.log("时间差距: " + (o - t.lastFoundTimeStamp)), 
...
function re(e) {
    if (Y(), f) console.log("正在连接中，但是又尝试发起连接设备，这是不应该的！"); else if (p) console.log("开发者想重复连接设备，这是不应该的！"); else {
        f = !0;
        var n = function() {
            te(function() {
            ...
            var r, o;
            v = e, w = t.mtu - 3, p = !0, console.log("MTU获取成功，当前的MTU是: " + w), r = n, o = function() {
                p = !1, D({
                    errno: 1509005,
                    errCode: 10100,
                    errMsg: "获取复卡机设备信息失败"
...
function oe(e, n) {
    ...
    }(0) : console.log("由于开发者的逻辑疏忽导致设备未连接就尝试发送数据！");
}
...
function ae(e, n, t) {
    return function() {
        var r = setTimeout(function() {
            ...
            if ("number" != typeof n || isNaN(n)) console.log("任务超时，但是在待处理命令回调列表中没有找到任务的回调对象！"); else {
                var a = o.splice(n, 1);
...
module.exports = {
    ...
    bytes2DarksideObj: function(e) {
        return (e instanceof Uint8Array || e instanceof Array) && 32 == e.length ? (console.log("par解析结果: " + G(e, 8, 8)), 
        {
            uid: X(e, 0, 4),
            nt1: X(e, 4, 4),
            par: G(e, 8, 8),
    ...
    startBLEDevicesAdapter: function(e) {
        c ? console.log("开发者重复调用了初始化，自动跳过！") : (c = !0, wx.openBluetoothAdapter({
            mode: "central",
            success: function(n) {
                0 == n.errno ? (u = !0, e(), console.log("适配器初始化成功！")) : (u = !1, console.log("适配器初始化失败！"), 
                D(n));
            },
            fail: D,
            complete: function() {
    ...
    closeBLEDevicesAdapter: function(e) {
        Y(), i ? console.log("开发者重复调用了反初始化，这是不应该的！") : (i = !0, te(function() {
    ...
    requestSetBLEDeviceName: function(e, n, t) {
        var r = fe(e);
        console.log('requestSetBLEDeviceName 检测到设备名称 "'.concat(e, '" 占用字节数: ') + r.length), 
        ...
        if (t.length > 42) {
            ...
            le(e, n, a[c++], r, function i(u) {
                if (null == u) o(null); else if (0 == u.status) if (255 != u.data[0]) {
                    ...
                    u.data = [ l ], o(u);
                } else console.log("当前进度: ".concat(c, ", ").concat(a.length)), c >= a.length ? (u.data = [ t.length ], 
