var e = require("39DE27D555C842DF5FB84FD20B718C74.js"), o = require("4F97F14255C842DF29F19945DB418C74.js"), n = !1, t = !1, i = function(e) {}, l = null, c = null;
...
function r(l) {
    o.disconnectExistsDevice(function() {
        n = !0, t = !1, e.deviceDisconnect(), e.deviceConnect({
            deviceId: l,
            connected: function(o) {
                console.log("欲OTA的设备已经连接: " + JSON.stringify(o) + ", 将会自动启动OTA过程！"), n && (n = !1, 
                e.startUpdate({
                    rebootMode: 2,
                    progress: function(e) {
                        e.txSize >= e.frimSize ? (console.log("更新成功"), wx.showToast({
                            title: "更新成功",
                            icon: "none"
                        }), t = !0, c = null) : "function" == typeof i && i(Math.round(e.txSize / e.frimSize * 100));
                    },
                    fail: function(e) {
...
function a() {
    ...
    if (null == n) {
        var t = e.load(c);
        if (void 0 !== t) return void wx.showModal({
            showCancel: !1,
            title: "固件错误",
            content: t
        });
