var e = require("3E90FCB755C842DF58F694B049818C74.js"), n = null;
...
function r() {
    var e = o(), n = a();
    if (console.log("phoneNumber是" + n), Object.keys(n).length <= 0) return wx.navigateTo({
    ...
    wx.request({
        ...
        success: function(e) {
            var n = e.data.status;
            console.log("后端token状态是" + JSON.stringify(e)), 1 == n && (c(), wx.navigateTo({
                url: "/pages/user-login-onekey/login"
            }));
        },
        fail: function(e) {
...
function p(e, n) {
    var t = u();
    for (var o in t) if (t[o] == e) return {
        isok: !1,
        uuid: null,
        message: "已经存在相同名称的卡片了"
    };
    var i = n();
    return 0 == e.length && (e = l()), t[i] = e, wx.setStorageSync("dump_nicks", t), 
    {
        isok: !0,
        uuid: i,
        message: "保存成功"
...
module.exports = {
    ...
    getDeviceBindStatus: function(e, n) {
        r();
        var i = o(), c = a();
        console.log("util  uuid是" + e), wx.request({
        ...
        wx.request({
            ...
            success: function(n) {
                if (console.log("剩余的次数是 " + JSON.stringify(n)), "会员已过期" == n.data.data.expirationTime) {
                    console.log("剩余的次数是空 ");
                    var t = "会员已过期", o = n.data.data.remain_count;
                    return e(o, i, t), !1;
                }
    ...
    checkActivity: function(e) {
        ...
        wx.request({
            ...
            success: function(n) {
                console.log("获取到的活动数据是 " + JSON.stringify(n)), console.log("获取到的活动类型是 " + JSON.stringify(n.data.activity_status)), 
                console.log("是否有参加活 " + JSON.stringify(n.data.isAttend));
                var t = n.data.activity_status, o = n.data.activity_type, i = n.data.isAttend;
                "on" == t && "yes" == i ? (e.setData({
                    sendVip: !0,
                    sendVipClose: "yes"
                }), console.log("活动打开也参加了" + e.data.sendVipClose)) : "on" == t && "no" == i ? (e.setData({
                    sendVip: !1,
                    activity_type: o
                }), console.log("活动打开没参加" + e.data.sendVipClose)) : "off" == t && (e.setData({
                    sendVip: !0,
                    sendVipClose: "yes"
    ...
    remainNumber1: function(e) {
        ...
        wx.request({
            ...
            success: function(n) {
                ...
                var t = n.data.data.remain_count, o = n.data.data.vip_end_date, i = n.data.data.expirationTime;
                e(t, o, i);
            },
            fail: function(e) {
                console.log(e);
    ...
    processBLEError: function(e) {
        wx.hideLoading({
            success: function() {
                10001 == e.errCode ? t("请开启手机蓝牙") : -1 == e.errCode ? t("连接成功！") : 10002 == e.errCode ? t("没有找到蓝牙设备") : 10003 == e.errCode ? t("蓝牙连接失败！") : 10006 == e.errCode ? t("当前连接已经断开") : 10009 == e.errCode ? wx.showModal({
                    title: "警告！",
                    content: "系统版本低于 4.3 不支持 BLE",
                    showCancel: !1
                }) : 10012 == e.errCode ? t("连接超时") : wx.showModal({
                    title: "警告！",
